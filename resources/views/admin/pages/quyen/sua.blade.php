      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{route('postSuaQuyen', $quyen->ma_quyen)}}" method="post">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="{{$quyen->ten_quyen}}" id="" name="ten_quyen" placeholder="Nhập Quyền" required="">
                </div>
              </div>
