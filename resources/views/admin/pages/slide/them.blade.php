            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('postThemSlide')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="" name="ten_slide" placeholder="Tên slide" required="">
                                </div>
