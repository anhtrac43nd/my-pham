  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Sửa Loại Sản Phẩm </a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{route('postSuaLoaiSanPham',$loai_san_pham->ma_loai)}}" method="post">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="{{$loai_san_pham->ten_loai}}" name="loai_san_pham" placeholder="Nhập Loại Sản Phẩm" required="">
                </div>
              </div>
