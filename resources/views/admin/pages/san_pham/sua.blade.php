      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{route('postSuaSanPham', $san_pham->ma_sp)}}" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="{{$san_pham->ten_sp}}" name="ten_san_pham" placeholder="Nhập Sản Phẩm" required="">
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="loai_sp">
                  	@foreach($loai_san_pham as $row)
                    	<option value="{{$row->ma_loai}}"  @if($san_pham->ma_loai == $row->ma_loai) selected="" @endif>
                    		{{$row->ten_loai}}
                    	</option>
                    @endforeach
                  </select>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="thuong_hieu">
                  	@foreach($thuong_hieu as $row)
                    	<option value="{{$row->ma_thuong_hieu}}" @if($san_pham->ma_thuong_hieu == $row->ma_thuong_hieu) selected="" @endif>
                    		{{$row->ten_thuong_hieu}}
                    	</option>
                    @endforeach
                  </select>
                ...
                <div class="form-group">
                  <label>Giá</label>
                  <input type="text" class="form-control" required="" value="{{$san_pham->don_gia}}" name="gia" placeholder="Nhập giá của sản phẩm ...">
                </div>
                <div class="form-group">
                    <label>Phần trăm khuyến mại</label>
                    <input type="text" class="form-control" required="" value="{{$san_pham->phan_tram_khuyen_mai}}" name="phan_tram_km" placeholder="Nhập giá của sản phẩm ...">
                </div>
                <div class="form-group">
                  <label for="exampleInputFile">File input</label>
                  <input type="file" name="hinh_anh" id="hinh_anh">
                  <p class="help-block">{{$san_pham->anh}}</p>
                  <img height="130px;" src="{{asset('')}}upload/hinh_anh/{{$san_pham->anh}}">
                </div>
                <div class="form-group">
