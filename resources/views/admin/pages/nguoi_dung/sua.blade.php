      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{route('postSuaNguoiDung', $nguoi_dung->ma_nd)}}" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="{{$nguoi_dung->ten_nd}}" name="ten_nguoi_dung" placeholder="Nhập Người Dùng" required="">
                </div>

                <div class="form-group">
                  <label for="">Số Điện Thoại</label>
                  <input type="text" class="form-control" value="{{$nguoi_dung->sdt}}" name="sdt" placeholder="Nhập Số Điện Thoại" required="" disabled="">
                </div>

                <div class="form-group">
                  <label for="">Địa Chỉ</label>
                  <input type="text" class="form-control" value="{{$nguoi_dung->dia_chi}}" name="dia_chi" placeholder="Nhập Địa Chỉ" required="">
                </div>
                
                <div class="form-group">
                  <label for="">Tên Tài Khoản</label>
                  <input type="text" class="form-control" value="{{$nguoi_dung->ten_tk}}" name="ten_tai_khoan" placeholder="Nhập Địa Chỉ" required="" disabled="">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="nhac_mat_khau" placeholder="Nhập Lại Mật Khẩu">
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="ma_quyen">
                  	@foreach($quyen as $row)
                    	<option value="{{$row->ma_quyen}}" @if($nguoi_dung->ma_quyen == $row->ma_quyen) selected="" @endif >{{$row->ten_quyen}}</option>
                    @endforeach
                  </select>
                </div>
