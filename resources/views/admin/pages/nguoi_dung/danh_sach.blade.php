...
@section('content')
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-2">
          <a href="{{route('themNguoiDung')}}"><button type="button" class="btn btn-block btn-primary">Thêm Người Dùng</button></a>
        </div>
      </div>
      <div class="row">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{$row->dia_chi}}</td>
                  <td>{{$row->ten_tk}}</td>
                  <td>{{$row->quyen->ten_quyen}}</td>
                  <th><a href="{{route('suaNguoiDung', $row->ma_nd)}}">Sửa</a>|
                      <a href="{{route('xoaNguoiDung', $row->ma_nd)}}">Xóa</a></th>
                </tr>
                @endforeach
                </tfoot>
              </table>
