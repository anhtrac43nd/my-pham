      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{route('suaThuongHieu',$thuong_hieu->ma_thuong_hieu)}}" method="post">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="{{$thuong_hieu->ten_thuong_hieu}}" name="thuong_hieu" placeholder="Nhập Thương Hiệu" required="">
                </div>
              </div>
